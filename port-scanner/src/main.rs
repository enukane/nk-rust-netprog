...
const MAXIMUM_PORT_NUM: i32 = 100;
...
fn send_packet(ts: &mut transport::TransportSender, packet_info: &PacketInfo) {
    ...
    for i in 1..MAXIMUM_PORT_NUM+1 {
        ...
        reregister_destination_port(i as u16, &mut tcp_header, packet_info);
...
fn main() {
    ...
    println!("my_ipaddr {} target_ipaddr {} my_port {} max_port {}",
        packet_info.my_ipaddr, packet_info.target_ipaddr, packet_info.my_port, packet_info.maximum_port);
